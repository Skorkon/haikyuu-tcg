...
const TRADUCCIONES = {
  "es": {
    "log": {
      ...
      "negarBloqueadorCentral": "Efecto activo: bloqueo del bloqueador central anulado",
      "negarBloqueadoresApoyo": "Efecto activo: el rival solo puede colocar al bloqueador central este turno",
      ...
      "bloqueoMinimoForzado": "Efecto de bloqueo mínimo: bloqueo insuficiente forzado",
  ...
  "en": {
    "log": {
      ...
      "negarBloqueadorCentral": "Active effect: central blocker block nullified",
      "negarBloqueadoresApoyo": "Active effect: rival can only place the central blocker this turn",
      "negarReceptorAlto": "Active effect: rival cannot place a receiver with base reception of 6 or more",
      ...
      "bloqueoMinimoForzado": "Minimum block effect: insufficient block forced",
  ...
  "fr": {
    "log": {
      ...
      "negarBloqueadorCentral": "Effet actif : bloc du bloqueur central annulé",
      "negarBloqueadoresApoyo": "Effet actif : le rival ne peut placer que le bloqueur central ce tour",
      "negarReceptorAlto": "Effet actif : le rival ne peut pas placer un receveur avec réception de base de 6 ou plus",
      ...
      "bloqueoMinimoForzado": "Effet de bloc minimum : bloc insuffisant forcé",
