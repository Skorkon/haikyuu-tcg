...
const TRADUCCIONES = {
  "es": {
    "log": {
      ...
      "ataqueAumentado": "+{valor} al ataque",
      "defensaAumentada": "+{valor} a la defensa",
      "ataqueReducido": "-{valor} al ataque del rival",
      ...
      "blockoutApoyoActivo": "Efecto activo: el primer bloqueador de apoyo rival irá directamente al trash",
      "blockoutApoyo": "Blockout de apoyo: {carta} va directamente al trash",
      ...
      "anularHabilidadPersonajeActivo": "Efecto activo: la habilidad de {carta} queda anulada este turno",
      "anularHabilidadPersonaje": "La habilidad de {carta} está anulada este turno",
      ...
      "robarCuandoRivalActivo": "Efecto activo: robarás 1 carta cada vez que el rival robe una carta por efectos",
      ...
      "descartaDesdeMano": "{jugador} descarta {carta} desde la mano para activar su habilidad",
      "cartaDescartadaCoste": "{carta} descartada como coste",
      "cartaRevelada": "Carta revelada: {carta}",
      "cartaReveladaEscuela": "Carta revelada: {carta} ({escuela})",
      ...
      "activarHabilidadNombre": "Activar habilidad {carta}",
  ...
  "en": {
    "log": {
      ...
      "ataqueAumentado": "+{valor} to attack",
      "defensaAumentada": "+{valor} to defense",
      "ataqueReducido": "-{valor} to rival attack",
      ...
      "blockoutApoyoActivo": "Active effect: the first rival support blocker will go directly to discard",
      "blockoutApoyo": "Support blockout: {carta} goes directly to discard",
      ...
      "anularHabilidadPersonajeActivo": "Active effect: {carta} ability is nullified this turn",
      "anularHabilidadPersonaje": "{carta} ability is nullified this turn",
      ...
      "robarCuandoRivalActivo": "Active effect: you will draw 1 card each time the rival draws a card by effects",
      ...
      "descartaDesdeMano": "{jugador} discards {carta} from hand to activate their ability",
      "cartaDescartadaCoste": "{carta} discarded as cost",
      "cartaRevelada": "Card revealed: {carta}",
      "cartaReveladaEscuela": "Card revealed: {carta} ({escuela})",
      ...
      "activarHabilidadNombre": "Activate ability {carta}",
  ...
  "fr": {
    "log": {
      ...
      "ataqueAumentado": "+{valor} à l'attaque",
      "defensaAumentada": "+{valor} à la défense",
      "ataqueReducido": "-{valor} à l'attaque du rival",
      ...
      "blockoutApoyoActivo": "Effet actif : le premier bloqueur de soutien rival ira directement à la défausse",
      "blockoutApoyo": "Blockout de soutien : {carta} va directement à la défausse",
      ...
      "anularHabilidadPersonajeActivo": "Effet actif : la capacité de {carta} est annulée ce tour",
      "anularHabilidadPersonaje": "La capacité de {carta} est annulée ce tour",
      ...
      "robarCuandoRivalActivo": "tu pioches 1 carte chaque fois que le rival pioche une carte par effets",
      ...
      "descartaDesdeMano": "{jugador} se défausse de {carta} depuis la main pour activer sa capacité",
      "cartaDescartadaCoste": "{carta} défaussée comme coût",
      "cartaRevelada": "Carte révélée : {carta}",
      "cartaReveladaEscuela": "Carte révélée : {carta} ({escuela})",
      ...
      "activarHabilidadNombre": "Activer la capacité {carta}",
  ...
  "": {
    "log": {
      ...
      "anularHabilidadPersonajeActivo": "",
      "anularHabilidadPersonaje": "",
